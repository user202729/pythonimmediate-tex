...
This \TeX\ package is compatible with Python package version |0.7.1|.
...
\begin{itemize}
	\item Download the following files and place it in the root folder of Overleaf:
		\begin{itemize}
			...
			\item \file{pythonimmediate_tex-0.7.1.zip}
		\end{itemize}
		The |0.7.1| part should be replaced with the desired version
...
\usepackage[python-executable={PYTHONPATH=pythonimmediate_tex-0.7.1.zip/pythonimmediate_tex-0.7.1/ python3},args={--mode=unnamed-pipe}]{pythonimmediate}
\end{verbatim}
As above, replace both occurrences of |0.7.1| with the downloaded version specified in the zip file above.
