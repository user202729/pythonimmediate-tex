...
\usepackage[python-executable={PYTHONPATH=pythonimmediate-tex-0.0.1.zip/pythonimmediate-tex-0.0.1/ python3},args={--mode=unnamed-pipe}]{pythonimmediate}
\end{verbatim}
...
\DescribeOption{args=}
Arguments to be passed to the Python executable. Run
\begin{verbatim}
