\ProvidesFile{pythonimmediate.tex}[2026/05/02 0.6.1 Library to run Python code]
...
This \TeX\ package is compatible with Python package version |0.7.3|.
...
download |.whl| file, include it in your Overleaf project, and specify where the package can be found to Python
...
\begin{itemize}
	\item Download the following files and place it in the root folder of Overleaf:
		\begin{itemize}
			...
			\item \file{pythonimmediate_tex-0.7.3-py3-none-any.whl}
		\end{itemize}
		The |0.7.3| part should be replaced with the desired version
		of the Python package.

		The |.sty| files can be downloaded from CTAN at 
		\url{https://ctan.org/pkg/pythonimmediate}.

		The |.whl| file containing Python source code
		can be downloaded from PyPI: \url{https://pypi.org/project/pythonimmediate-tex/\#files}.

		Remark: Only the |.whl| is always required, the remaining files may have already been included in \TeX\ Live. Currently the \LaTeX\ package version 0.4.0 is included in \TeX\ Live 2023, you would need to download \LaTeX\ version 0.5.0 or newer from CTAN.
...
\usepackage[python-executable={PYTHONPATH=pythonimmediate_tex-0.7.3-py3-none-any.whl python3},args={--mode=unnamed-pipe}]{pythonimmediate}
\end{verbatim}
As above, replace both occurrences of |0.7.3| with the downloaded version specified in the zip file above.
