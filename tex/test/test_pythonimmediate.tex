...
\tl_put_right:Nn\tmp{python-executable={PYTHONPATH=/home/user202729/TeX/pythonimmediate/ ~ python3},}
...
""".count('\t'), 5)
	...
	def test_preserve_unicode_chars(self)->None:
		codes = [198, 178, 215, 8308, 8477, 120143]
		if os.getcwd() == '/compile':
			# probably overleaf
			codes = codes[:-1]
		for char, code in zip('Æ²×⁴ℝ𝕏', codes):
			assert ord(char)==code  # last one expected to fail on Overleaf since Overleaf does not support characters outside BMP
